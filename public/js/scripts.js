...
window.addEventListener('DOMContentLoaded', event => {
  ...
  form.addEventListener('submit', async (event) => {
    ...
    $("#idealWeight").html("Value Idea Weight: " + (weightJSON.idealWeight * 2.20462).toFixed(2)+" lbs");
    ...
    $("#idealWeight_").html("Value Idea Weight (Lbs):  " + (weightJSON.idealWeight * 2.20462).toFixed(2));
